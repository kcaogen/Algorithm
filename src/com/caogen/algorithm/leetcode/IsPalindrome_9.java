...
public class IsPalindrome_9 {
    ...
    private static void algorithmTest() {
        int[] nums = {121, -121, 10};
        for (int number : nums) {
            boolean result1 = IsPalindrome_9.isPalindrome(number);
            boolean result2 = IsPalindrome_9.isPalindromeByBest(number);
    ...
    private static void performanceTest() {
        ...
        for (int n : dataSize) {
            ...
            for (int number : data) {
                IsPalindrome_9.isPalindrome(number);
            }
            ...
            for (int number : data) {
                IsPalindrome_9.isPalindromeByBest(number);
            }
