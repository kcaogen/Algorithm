...
public class HasAlternatingBits_693 {
    ...
    private static void algorithmTest() {
        int[] nums = {5, 7, 11};
        for (int number : nums) {
            boolean result1 = HasAlternatingBits_693.hasAlternatingBits(number);
            boolean result2 = HasAlternatingBits_693.hasAlternatingBitsByBest(number);
    ...
    private static void performanceTest() {
        ...
        for (int n : dataSize) {
            ...
            for (int number : data) {
                HasAlternatingBits_693.hasAlternatingBits(number);
            }
            ...
            for (int number : data) {
                HasAlternatingBits_693.hasAlternatingBitsByBest(number);
            }
